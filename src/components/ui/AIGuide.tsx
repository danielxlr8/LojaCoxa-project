...
import { MessageSquareText, X, Sparkles, Send, Bot, ArrowRight } from "lucide-react";
import Link from "next/link";
import Image from "next/image";

// Simulated AI Q&A Flow
const AI_FLOW = [
  { text: "Fala, Coxa-branca! Estava indeciso sobre qual manto levar? Me diz: você procuro algo mais para jogar e suar a camisa, ou casual para torcer?", isBot: true },
];
